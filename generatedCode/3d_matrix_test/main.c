...
lhs_data1[(iter2-1) + (iter3-1)*3 + (iter1-1)*2*3 + (1-1)*2*3*1] = counter;
counter = counter + 1;
...
lhs_data2[(d1_4-1) + (d0_4-1) * 3 + (d2_4-1) * 2 * 3 + (d3_4-1) * 2 * 3 * 5] = counter;
counter = counter + 1;
