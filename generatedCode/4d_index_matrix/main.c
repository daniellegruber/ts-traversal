...
lhs_data1[(iter4-1) + (iter3-1)*3 + (iter2-1)*2*3 + (iter1-1)*2*3*4] = counter + 0.5;
//a(i,j,k,l) = counter;
counter = counter + 1;
...
double tmp5;
indexM(mat1, &tmp5, 4, iter8, iter9, iter7, iter6);
printf("\n%f\n", tmp5);
...
double tmp8;
indexM(mat1, &tmp8, 4, iter13, iter12, iter11, iter10);
printf("\n%f\n", tmp8);
...
double tmp11;
indexM(mat1, &tmp11, 1, (d1_4) + (d0_4-1) * 3 + (d2_4-1) * 2 * 3 + (d3_4-1) * 2 * 3 * 4);
printf("\n%f\n", tmp11);
...
int ndim2 = 4;
int dim2[4] = {2, 3, 4, 5};
Matrix * tmp15 = zerosM(ndim2, dim2);
Matrix * a1 = tmp15;
double* lhs_data2 = i_to_d(tmp15);
counter = 0;
...
lhs_data2[(d1_5-1) + (d0_5-1) * 3 + (d2_5-1) * 2 * 3 + (d3_5-1) * 2 * 3 * 4] = counter + 0.5;
//a(i) = counter;
counter = counter + 1;
...
double tmp18;
indexM(mat2, &tmp18, 4, iter19, iter20, iter18, iter17);
printf("\n%f\n", tmp18);
...
double tmp21;
indexM(mat2, &tmp21, 4, iter24, iter23, iter22, iter21);
printf("\n%f\n", tmp21);
...
double tmp24;
indexM(mat2, &tmp24, 1, (d1_8) + (d0_8-1) * 3 + (d2_8-1) * 2 * 3 + (d3_8-1) * 2 * 3 * 4);
printf("\n%f\n", tmp24);
