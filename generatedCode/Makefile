...
updategithub:
	git --git-dir $$TS_TRAVERSAL/.git pull origin master; \
	git --git-dir $$TS_TRAVERSAL/.git add -A && git commit -m "$(MESSAGE)"; \
	git --git-dir $$TS_TRAVERSAL/.git push origin master; \
