...
int main(void) {
	...
	for (int i = 1; i <= 9; ++ i) {
		...
		int idx7 = convertSubscript(ndim5, dim5, i);
		int idx8 = convertSubscript(ndim1, dim1, 7);
		lhs_data3[idx7] = tmp13;
	...
	for (int i = 1; i <= 9; ++ i) {
		...
		int idx13 = convertSubscript(ndim7, dim7, i);
		int idx14 = convertSubscript(ndim1, dim1, 9);
		lhs_data5[idx13] = tmp19;
