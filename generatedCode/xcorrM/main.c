...
int main(void) {
	...
	for (int i = 1; i <= 10; ++ i) {
		int tmp7 = i * i;
		int idx1 = convertSubscript(ndim5, dim5, i);
	...
	for (int i = 1; i <= 10; ++ i) {
		double tmp9 = i * i + 0.5;
		int idx4 = convertSubscript(ndim6, dim6, i);
	...
	int idx6 = convertSubscript(ndim1, dim1, 6);
	matrices[6] = tmp8;
	int ndim7 = 2;
	int dim7[2] = {20, 1};
	...
	for (int i = 1; i <= 20; ++ i) {
		...
		int idx8 = convertSubscript(ndim1, dim1, 7);
		lhs_data3[idx7] = tmp11;
	...
	int idx15 = convertSubscript(ndim1, dim1, 9);
	matrices[9] = tmp14;
	int ndim10 = 2;
	int dim10[2] = {1, 10};
	...
	for (int i = 1; i <= 10; ++ i) {
		...
		int idx16 = convertSubscript(ndim10, dim10, i);
		int idx17 = convertSubscript(ndim1, dim1, 10);
	...
	int idx18 = convertSubscript(ndim1, dim1, 10);
	matrices[10] = tmp16;
