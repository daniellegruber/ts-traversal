...
int main(void) {
		...
		for (int iter2 = 1; iter2 <= 4; ++ iter2) {
			for (int iter3 = 1; iter3 <= 2; ++ iter3) {
				for (int iter4 = 1; iter4 <= 3; ++ iter4) {
					double tmp1= counter + 0.5;
					lhs_data1[(iter4-1) + (iter3-1)*3 + (iter2-1)*2*3 + (iter1-1)*2*3*4] = tmp1;
					counter = counter + 1;
		...
		for (int iter7 = 1; iter7 <= 4; ++ iter7) {
			for (int iter8 = 1; iter8 <= 2; ++ iter8) {
				for (int iter9 = 1; iter9 <= 3; ++ iter9) {
					double tmp2;
					indexM(mat1, &tmp2, 4, iter8, iter9, iter7, iter6);
					printf("\n%f\n", tmp2);
		...
		for (int iter11 = 1; iter11 <= 4; ++ iter11) {
			for (int iter12 = 1; iter12 <= 3; ++ iter12) {
				for (int iter13 = 1; iter13 <= 2; ++ iter13) {
					double tmp3;
					indexM(mat1, &tmp3, 4, iter13, iter12, iter11, iter10);
					printf("\n%f\n", tmp3);
	...
	for (int iter14 = 1; iter14 <= 120; ++ iter14) {
		...
		double tmp4;
		indexM(mat1, &tmp4, 1, (d1_4) + (d0_4-1) * 3 + (d2_4-1) * 2 * 3 + (d3_4-1) * 2 * 3 * 4);
		printf("\n%f\n", tmp4);
	...
	for (int iter15 = 1; iter15 <= 120; ++ iter15) {
		...
		double tmp5= counter + 0.5;
		lhs_data2[(d1_5-1) + (d0_5-1) * 3 + (d2_5-1) * 2 * 3 + (d3_5-1) * 2 * 3 * 4] = tmp5;
		counter = counter + 1;
		...
		for (int iter18 = 1; iter18 <= 4; ++ iter18) {
			for (int iter19 = 1; iter19 <= 2; ++ iter19) {
				for (int iter20 = 1; iter20 <= 3; ++ iter20) {
					double tmp6;
					indexM(mat2, &tmp6, 4, iter19, iter20, iter18, iter17);
					printf("\n%f\n", tmp6);
		...
		for (int iter22 = 1; iter22 <= 4; ++ iter22) {
			for (int iter23 = 1; iter23 <= 3; ++ iter23) {
				for (int iter24 = 1; iter24 <= 2; ++ iter24) {
					double tmp7;
					indexM(mat2, &tmp7, 4, iter24, iter23, iter22, iter21);
					printf("\n%f\n", tmp7);
	...
	for (int iter25 = 1; iter25 <= 120; ++ iter25) {
		...
		double tmp8;
		indexM(mat2, &tmp8, 1, (d1_8) + (d0_8-1) * 3 + (d2_8-1) * 2 * 3 + (d3_8-1) * 2 * 3 * 4);
		printf("\n%f\n", tmp8);
