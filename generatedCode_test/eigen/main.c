...
int main(void) {
	...
	int ndim13= 2;
	int dim13[2]= {3,3};
	matrices[12] = zerosM(ndim13, dim13);
	...
	Matrix *mat7 = createM(ndim13, dim13, 0);
	...
	for (int iter15 = 1; iter15 <= 14; ++ iter15) {
		...
		printf(stdout, 'Eigenvalues:\n');
		printM(lambda1);
		printf(stdout, 'Eigenvectors:\n');
		printM(V1);
