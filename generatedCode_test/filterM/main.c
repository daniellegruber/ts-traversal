...
int main(void) {
	...
	for (int iter4 = 1; iter4 <= 10; ++ iter4) {
		...
		lhs_data3[(d1_15-1) + (d0_15-1)] = tmp4;
	...
	for (int iter6 = 1; iter6 <= 20; ++ iter6) {
		...
		lhs_data4[(d1_21-1) + (d0_21-1)] = tmp5;
	...
	for (int iter8 = 1; iter8 <= 20; ++ iter8) {
		...
		lhs_data5[(d1_27-1) + (d0_27-1)] = tmp6;
	...
	for (int iter10 = 1; iter10 <= 20; ++ iter10) {
		...
		lhs_data6[(d1_33-1) + (d0_33-1)] = tmp7;
	...
	for (int iter12 = 1; iter12 <= 10; ++ iter12) {
		...
		lhs_data7[(d1_39-1) + (d0_39-1)] = tmp8;
