...
int main(void) {
	...
	Matrix *mat4 = createM(ndim6, dim6, 2);
	...
	Matrix *mat5 = createM(ndim7, dim7, 0);
	...
	Matrix *mat6 = createM(ndim8, dim8, 0);
	...
	// Write matrix mat7
	int size7 = 1;
	for (int iter14 = 0 ; iter14 < ndim9; iter14++)
	{
		size7 *= dim9[iter14];
	}
	Matrix *mat7 = createM(ndim9, dim9, 0);
	...
	// Write matrix mat8
	int size8 = 1;
	for (int iter16 = 0 ; iter16 < ndim10; iter16++)
	{
		size8 *= dim10[iter16];
	}
	Matrix *mat8 = createM(ndim10, dim10, 0);
	...
	// Write matrix mat9
	int size9 = 1;
	for (int iter18 = 0 ; iter18 < ndim11; iter18++)
	{
		size9 *= dim11[iter18];
	}
	Matrix *mat9 = createM(ndim11, dim11, 2);
	...
	// Write matrix mat10
	int size10 = 1;
	for (int iter20 = 0 ; iter20 < ndim12; iter20++)
	{
		size10 *= dim12[iter20];
	}
	Matrix *mat10 = createM(ndim12, dim12, 2);
	...
	int ndim13= 2;
	int dim13[2]= {3,3};
	matrices[0] = zerosM(ndim13, dim13);
	int ndim14= 2;
	int dim14[2]= {3,3};
	matrices[1] = onesM(ndim14, dim14);
	int ndim15= 2;
	int dim15= {3, 3};
	...
	int ndim17= 2;
	int dim17[2]= {3,3};
	matrices[4] = zerosM(ndim17, dim17);
	...
	// Write matrix mat11
	int size11 = 1;
	for (int iter22 = 0 ; iter22 < ndim17; iter22++)
	{
		size11 *= dim17[iter22];
	}
	Matrix *mat11 = createM(ndim17, dim17, 0);
	...
	int ndim18= 2;
	int dim18[2]= {3,3};
	matrices[5] = zerosM(ndim18, dim18);
	...
	// Write matrix mat12
	int size12 = 1;
	for (int iter24 = 0 ; iter24 < ndim18; iter24++)
	{
		size12 *= dim18[iter24];
	}
	Matrix *mat12 = createM(ndim18, dim18, 1);
	...
	int ndim19= 2;
	int dim19[2]= {3,3};
	matrices[6] = zerosM(ndim19, dim19);
	...
	// Write matrix mat13
	int size13 = 1;
	for (int iter26 = 0 ; iter26 < ndim19; iter26++)
	{
		size13 *= dim19[iter26];
	}
	Matrix *mat13 = createM(ndim19, dim19, 2);
	...
	int ndim20= 2;
	int dim20[2]= {3,3};
	matrices[7] = zerosM(ndim20, dim20);
	...
	// Write matrix mat14
	int size14 = 1;
	for (int iter28 = 0 ; iter28 < ndim20; iter28++)
	{
		size14 *= dim20[iter28];
	}
	Matrix *mat14 = createM(ndim20, dim20, 0);
	...
	int ndim21= 2;
	int dim21[2]= {3,3};
	matrices[8] = zerosM(ndim21, dim21);
	...
	// Write matrix mat15
	int size15 = 1;
	for (int iter30 = 0 ; iter30 < ndim21; iter30++)
	{
		size15 *= dim21[iter30];
	}
	Matrix *mat15 = createM(ndim21, dim21, 1);
	...
	int ndim22= 2;
	int dim22[2]= {3,3};
	matrices[9] = zerosM(ndim22, dim22);
	...
	// Write matrix mat16
	int size16 = 1;
	for (int iter32 = 0 ; iter32 < ndim22; iter32++)
	{
		size16 *= dim22[iter32];
	}
	Matrix *mat16 = createM(ndim22, dim22, 2);
	...
	int ndim23 = 2;
	int dim23[2] = {3,3};
	matrices[10] = createM(ndim23, dim23, 0);
	int *input1 = NULL;
	...
	int ndim24 = 2;
	int dim24[2] = {3,3};
	matrices[1] = createM(ndim24, dim24, 1);
	double *input2 = NULL;
	...
	for (int iter33 = 3; iter33 <= 12; ++ iter33) {
		...
		printf(stdout, 'Integer exponents\n');
		...
		printf(stdout, 'Double exponents\n');
		for (int iter35 = -3; iter35 <= 1.9; iter35 += 0.2) {
			printf(stdout, 'Exponent: %.4f\n');
			int d0_55 = iter33 % 11;
			if (d0_55 == 0) {
				d0_55 = 11;
			}
		...
		printf(stdout, 'Complex exponents\n');
